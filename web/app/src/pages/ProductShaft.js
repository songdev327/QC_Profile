    ...
    <>
      <Template>
        <div className="signup_container d-flex justify-content-center mt-5">
          <div className="signup_form w-50" id="record-change-tool-shaft">
            <div className="card card-outline card-warnig">
              <div className="card-header" id="record-change-tool-shaft">
                <div className="card-title fw-bold">RECORD CHANGE TOOL ( SHAFT )</div>
              </div>
                      ...
                      <div className="col-sm-2 mt-3">
                        <div className="form-group clearfix">
                          <div className="d-inline">
                            <input
                              onChange={(e) =>
                                setProduct({ ...product, t1: e.target.checked ? "T01" : "-", })
                              }
                              type="checkbox"
                              id="checkboxPrimary1"
                            />
