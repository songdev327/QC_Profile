...
function ToolNumberSearchShaftTB(props) {
  ...
  const fetchDataSearch = async (machine) => {
    try {
      ...
      const response = await axios.post(
        config.api_path + "/product/ProductMCQC_TB",
  ...
  const handlePageClick = async (data) => {
    ...
    try {
      const response = await axios.get(
        `${config.api_path}/product/listNewMachineShaftTB?offset=${offset}&limit=${limit}`,
        config.headers()
      );
  ...
  const getMachines = async () => {
    try {
      const response = await axios.get(config.api_path + "/machinesTB/listShaft");
  ...
  const getMachinesSearch = async () => {
    try {
      const response = await axios.get(config.api_path + "/getDataMCTBSearch");
 ...
 const handleSaveCancelRecord = async (e) => {
  ...
  const handleOkClickToolNumberListTB = async () => {
    try {
      ...
      const response = await axios.post(
        `${config.api_path}/api/toolNumBerListNewSpecTB`,
        {
          machineNumber: machineNumber,
    ...
    try {
      ...
      if (
        ...
        const updateProductPayload = {
          ...
          end_time_qc_by_off: end_time_qc_line || end_time_qc_lineAuto || null,
            ...
            <div className="card-body" id="bodyRoncom">
              <div className="container" id="tool-number">
                <button
                  ...
                  id="toolNumber-auto"
                  type="button"
                  onClick={handleOkClickToolNumberListTB}
                >
                  SELECT TOOL NUMBER
                </button>
              </div>
...
export default ToolNumberSearchShaftTB;
