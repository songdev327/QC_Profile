...
function ToolNumberSearchShaftTCH(props) {
  ...
  const fetchDataSearch = async (machine) => {
    try {
      ...
      const response = await axios.post(
        config.api_path + "/product/ProductMCQC_TCH",
  ...
  const handlePageClick = async (data) => {
    ...
    try {
      const response = await axios.get(
        `${config.api_path}/product/listNewMachineShaftTCH?offset=${offset}&limit=${limit}`,
        config.headers()
      );
  ...
  const getMachines = async () => {
    try {
      const response = await axios.get(config.api_path + "/machinesTCH/listShaft");
  ...
  const getMachinesSearch = async () => {
    try {
      const response = await axios.get(config.api_path + "/getDataMCTCHSearch");
  ...
  const handleMachineSelect = async (selectedOption) => {
    ...
    try {
      ...
      if (response.data.message === "success") {
        ...
        handleOkClickToolNumberListTCH();
      } else {
        Swal.fire({
          title: "error",
 ...
 const handleSaveCancelRecord = async (e) => {
  ...
  const handleOkClickToolNumberListTCH = async () => {
    try {
      ...
      const response = await axios.post(
        `${config.api_path}/api/toolNumBerListNewSpecTCH`,
        {
          machineNumber: machineNumber,
            ...
            <div className="card-body" id="bodyRoncom">
              <div className="container" id="tool-number">
                <button
                  ...
                  id="toolNumber-auto"
                  type="button"
                  onClick={handleOkClickToolNumberListTCH}
                >
                  SELECT TOOL NUMBER
                </button>
              </div>
...
export default ToolNumberSearchShaftTCH;
