...
function ToolNumberSearchShaftTTC(props) {
  ...
  const fetchDataSearch = async (machine) => {
    try {
      ...
      const response = await axios.post(
        config.api_path + "/product/ProductMCQC_TTC",
  ...
  const handlePageClick = async (data) => {
    ...
    try {
      const response = await axios.get(
        `${config.api_path}/product/listNewMachineShaftTTC?offset=${offset}&limit=${limit}`,
        config.headers()
      );
  ...
  const getMachines = async () => {
    try {
      const response = await axios.get(config.api_path + "/machinesTTC/listShaft");
  ...
  const getMachinesSearch = async () => {
    try {
      const response = await axios.get(config.api_path + "/getDataMCTTCSearch");
  ...
  const handleMachineSelect = async (selectedOption) => {
    ...
    try {
      ...
      if (response.data.message === "success") {
        ...
        handleOkClickToolNumberListTTC();
      } else {
        Swal.fire({
          title: "error",
  ...
  const handleOkClickToolNumberListTTC = async () => {
    try {
      ...
      const response = await axios.post(
        `${config.api_path}/api/toolNumBerListNewSpecTTC`,
        {
          machineNumber: machineNumber,
            ...
            <div className="card-body" id="bodyRoncom">
              <div className="container" id="tool-number">
                <button
                  ...
                  id="toolNumber-auto"
                  type="button"
                  onClick={handleOkClickToolNumberListTTC}
                >
                  SELECT TOOL NUMBER
                </button>
              </div>
...
export default ToolNumberSearchShaftTTC;
