function ModalStatusPass(props) {
              ...
              <div className={modalSize}>
                  <div className="modal-content">
                      <div className="modal-header">
                          ...
                          <button onClick={closeModal} type="button" className="btn-close" data-dismiss="modal" aria-label="Close"></button>
                      </div>
...
export default ModalStatusPass;