...
function MachineTNForProduct() {
    ...
    const [machine_type, setMachine_type] = useState("TN");  // state สำหรับควบคุม
    ...
    const fetchDataProductImage = async () => {
        try {
            const response = await axios.post(config.api_path + "/productImage/searchTN", {
    ...
    const getToolNumber = async () => {
        try {
            const response = await axios.get(config.api_path + "/productImage/getToolNumberTN");
                ...
                <div className="content-wrapper">
                    <div className="container-fluid" id="list-master">
                        <h1 className="" style={{ marginLeft: "10px" }}>
                            TN List Master Record Change Tool PDF
                        </h1>
                    </div>
                    <hr />
                                    ...
                                    <div className="table-wrapper">
                                        <table className="col-6 table table-bordered table-info">
                                            <thead className="bg-dark">
                                                <tr>
                                                    <th className="text-black text-center">TN</th>
...
export default MachineTNForProduct;
