      ...
      >
          ...
          <thead>
            <tr>
              <th style={{ padding: "10px" }}>
                ...
                />
                <span className="spacing">Oil OK</span>
                <input
                  type="checkbox"
                  style={{ marginLeft: "10px", width: "20px", height: "20px" }}
                />
                <span className="spacing">Air OK</span>
                <input
                  type="checkbox"
                  style={{ marginLeft: "10px", width: "20px", height: "20px" }}
                />
                <span className="spacing">Pusher OK</span>
                <input
                  type="checkbox"
                  style={{ marginLeft: "10px", width: "20px", height: "20px" }}
                />
                <span className="spacing">Stopper OK</span>
              </th>
            </tr>
          </thead>
        </table>
        ...
        >
          <thead>
            <tr>
              <span className="spacing"></span>
              <td style={{ padding: "3px" }}>Adjust by:________</td>
              <td style={{ padding: "3px" }}>Part Set up:____pcs.</td>
              <td style={{ padding: "3px" }}>A/S 1:____pcs.</td>
              <td style={{ padding: "3px" }}>A/S 2:____pcs.</td>
              <td style={{ padding: "3px" }}>A/S 3:____pcs.</td>
            </tr>
          </thead>
        </table>
        {/* Inspection Details2 */}
        ...
        >
          <thead>
            <tr>
              <span className="spacing"></span>
              <span className="spacing"></span>
              <td style={{ padding: "3px" }}>QC Inprocess BY:________</td>
              <span className="spacing"></span>
              <span className="spacing"></span>
              <td style={{ padding: "3px" }}>(A/Set 1:_______)</td>
              <td style={{ padding: "3px" }}>(A/Set 2:_______)</td>
              <td style={{ padding: "3px" }}>(A/Set 3:_______)</td>
            </tr>
          </thead>
        </table>
        {/* Inspection Details3 */}
        ...
        >
          <thead>
            <tr>
              ...
              <span className="spacing"></span>
              <span className="spacing"></span>
              <td style={{ padding: "3px" }}>QC INPROCESS BY:____________</td>
              <td style={{ padding: "3px" }}>APPROVED BY:_____________</td>
            </tr>
          </thead>
        </table>
...
export default ToolingFormAuditCH;
